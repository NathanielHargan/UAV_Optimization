...
\begin{document}
	...
	\subsection{Transient} \label{ss:transient}
		...
		- The transient stress is obtained from the transient 
	...
	\subsubsection{Displacement} \label{sss:displacement}
		- The static solver as used to calculate the displacement
		- 1/8 of the mass of the frame  was modelled as a point load at the end of the UAV arm pointing upward while the center of the UAV is fixed 
		$$ g_1(d_a,t_a,d_s,t_s,r_s,t_f,t_w) = d_{tip} \le d_{allowable} $$
	\subsubsection{Stress} \label{sss:stress}
		- Similarly, for the stess caclualtion the 
	...
	\subsubsection{Damage} \label{sss:damage}
		...
		Thie mission profile with a rev up and rev down time of 5 seconds was added to the mission profile. 
	...
	\chapter{Results} \label{ch:results}
		- The initial guess	were based off of measurement of the orginial UAV design. 
		- arm_diameter, strut diamter, and 
