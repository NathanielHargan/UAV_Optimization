...
class DroneForces:
    def __init__(self, mass, surface_area, drag_coeff, profile):
        self.mass = mass
    ...
    def time_solve(self, t):
        ...
        force_drag_y_mag = self.surface_area * air_density * self.drag_coeff * (v_y ** 2) / 2
        force_drag_y_dir = 0
        if v_y > 0:
            force_drag_y_dir = -1
        else:
...
if __name__ == '__main__':
    ...
    drag_1, thrust_1 = d1_forces.force_time_solve(15)
    print(thrust_1)
    print(drag_1)
#%%
